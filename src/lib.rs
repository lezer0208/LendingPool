...
#[derive(Debug)]
pub struct LendingPoolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LendingPoolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LendingPool processing");
    
    let mut processor = LendingPoolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LendingPoolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LendingPoolProcessor::new(false);
